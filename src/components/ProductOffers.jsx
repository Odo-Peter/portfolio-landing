...
const ProductOffers = () => {
  return (
    <div id="product-offers" className="py-14 border-b border-gray-400">
      ...
      <div className="text-sm md:text-base text-gray-600">
        ...
        <ul className="list-disc pl-10 flex flex-col gap-y-2">
          ...
          <li className="mb-4">
            <p className="mb-6">
              Next, we will scrape the offers of this product using its
          ...
          <li className="my-4">
            <p>
              ...
              are structured offers details of the product.
            </p>
            <img alt="demo" src={pic5} className="my-2" />
            <p>
